...
Начнем с самых простых и универсальных подходов, рассмотрим базовые акронимы: **KISS**, **YAGNI** и **DRY** -- эти принципы сами по себе довольно очевидны и исходят из простого здравого смысла, однако всегда удобно, когда даже настолько простые вещи описаны и формализованы.
### KISS
...
## Refernces
1. Bugayenko, Yegor. _Elegant Objects Volume 1 by Yegor Bugayenko_. Yegor Bugayenko, 2020.
2. Hunt, Andrew, et al. _The Pragmatic Programmer: From Journeyman to Master_. Addison-Wesley, 2015.
